...
.nav .nav-links a:hover {
  color: darkgreen; /* Change the text color on hover (you can choose any color you prefer) */
}


/* Add this CSS for the hover-box */
...
<body>
  <!-- <div class="head">
    ...
    <a href="index.php" style="text-decoration: none; color: white" target="_blank"><span><ion-icon name="log-out-outline"></ion-icon>
        <div style="margin-left: 1.5rem; margin-top: -1.5rem"> Log Out</div></a>
    </span>
  </div> -->
...
<div class="main">
  ...
  <div style="margin-left: 40.7rem; margin-top: -0.5rem; color:rgb(102, 91, 91)"></div>
  ...
  // session_start();
        ...
        foreach ($query as $que) {
          ...
          echo "<a href='pkg_description.php?pname=" . urlencode($que['pname']) . "' style='text-decoration: none; '  target='_blank'>";
...
?>
  ...
  <div class="full" style="width: 100%">
    <div class="explor">
      ...
      <div style="margin-left: -3.5rem; color: rgb(243, 237, 237)"></div>
    </div>
    <div class="footer">
    ...
    <div style="margin-left: 3rem; margin-top: 5rem; width: 35rem; font-size: 1rem; color: white ">© Copyright © 2023
